"""26-column page intelligence report builder."""
...
SORT_OPTIONS = [
    ...
    (col, col) for col in REPORT_COLUMNS
    if col not in {"Domain", "Page Title", "Full URL"}
]
...
def build_page_report(
    ...
    """Build 26-column page intelligence report.
    ...
    for url, group in citations.groupby("clean_url"):
        ...
        # Page title: prefer citation_title from data, fall back to URL slug
